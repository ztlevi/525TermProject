										...
										<?php
											...
											echo '	<table border="0" width="100%">
												 ...
												 <tr align="center" bgcolor="#EEE9F3">
													 <td class = "title">Item Details</td>
												</tr>
												<tr>
													<td><hr color="purple"></td>
												</tr>
											...
											<table border="0"  width="100%" bgcolor="#ffffff">
												...
												<tr valign="bottom" >
														...
														<a href="'.$row['b_img'].'" rel="lightbox"></a>
											...
											<table border="0" width="100%">
												 ...
												 {
													echo ' <td class="title"><a href="process_cart.php?nm='.$row['b_nm'].'&cat='.$_GET['cat'].'&rate='.$row['b_price'].'">
														<input type="button" class="button" value="Add to Chart"></input>
													</a></td>';
												}
												else
												{
													echo '<td class="title"><input type="button" class="button" value="Add to Chart"></input><br><a href="register.php"> <h4>Please Login..</h4></a></td>';
												}
												echo '</tr>
											</table>';
										?>
